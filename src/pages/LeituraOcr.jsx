...
const tourSteps = [
  ...
  },
  {
    ...
    title: '11º passo',
    description: 'Note também que aqui fica gravado o valor do último elemento estrutural lido. Logo basta selecionar o restante que ele irá considerar as posições referente ao último elemento.',
    side: 'left',
    align: 'end',
  },{
    id: 'spot-12',
    ...
    title: '23º passo',
    description: 'A inserção é feita acima da posição que foi clicado. Note que ele já preenche os valores de elemento e posição automático. Preencha os demais valores e prosiga.',
    side: 'left',
    align: 'end',
  },{
    id: 'spot-24',
